% =============================================================================
% ppt2.tex - Scientific Academic Defense & Technical Presentation Deck
...
\titlegraphic{\vspace{-0.2cm}\includegraphics[height=1.1cm,keepaspectratio]{ins.jpeg}}
  ...
  \begin{columns}[T]
    \begin{column}{0.48\textwidth}
      \begin{itemize}\setlength{\itemsep}{0.25cm}
        ...
        \item Literature Review \& Research Gap
        \item Proposed Methodology \& System Architecture
        \item Implementation \& Risk Scoring
      \end{itemize}
    \end{column}
    \begin{column}{0.48\textwidth}
      \begin{itemize}\setlength{\itemsep}{0.25cm}
        \item Experimental Setup
        \item Results \& Performance Evaluation
...
% =====================================================================
\section{Implementation \& Risk Scoring}
% =====================================================================

\begin{frame}{Implementation: The PDSS Formula}
  \small
...
\begin{frame}{Implementation: Auxiliary ML Calibration}
  \small
...
\begin{frame}{Implementation: DAG Remediation Engine}
  \footnotesize
  \begin{columns}[T]
...
\begin{frame}{Results: ML Calibration \& Risk Scoring Performance}
  \footnotesize
  \begin{columns}[T]
    \begin{column}{0.51\textwidth}
      \textbf{Model Evaluation \& Training Rigor:}
      \begin{itemize}\setlength{\itemsep}{0.12cm}
        \item \textbf{Synthetic Dataset Validation ($\mathbf{N=1,000}$):} Due to statutory privacy frameworks, harvesting real individual exposures is legally prohibitive. Synthetic profiles were mathematically formulated to preserve authentic covariance.
...
\begin{frame}{Results: Latency, Reliability \& Security Evaluation}
  \small
...
\begin{frame}{System Demonstration 1: Architecture \& Data Isolation}
  \begin{figure}
    \centering
...
\begin{frame}{System Demonstration 2: PDSS Dashboard \& Identity Graph}
  \begin{figure}
    \centering
...
\begin{frame}{System Demonstration 3: Automated DAG Neutralization}
  \begin{figure}
    \centering
...
\begin{frame}{Discussion}
  ...
  \begin{itemize}\setlength{\itemsep}{0.20cm}
    \item \textbf{Finding 1:} Local PDSS evaluation significantly reduces latency compared with the cloud baseline.
    \item \textbf{Finding 2:} Deterministic scoring provides explicit accountability and explainability.
    \item \textbf{Finding 3:} Residual ML adds bounded calibration rather than replacing the deterministic score, ensuring stability.
    \item \textbf{Finding 4:} DAG-based remediation converts unstructured findings into logically ordered actionable tasks.
    \item \textbf{Finding 5:} The system currently depends on external reconnaissance sources and synthetic ML calibration, yet maintains complete reliability and tenant isolation.
  \end{itemize}
  \vspace{0.15cm}
  \textbf{Implications:} Client-controlled zero-trust architectures can effectively out-perform centralized cloud threat servers in both latency and privacy, providing an explainable, robust framework for digital exposure assessment.
\end{frame}
...
\begin{frame}{Engineering Challenges \& Future Work}
  \small
  \begin{itemize}\setlength{\itemsep}{0.28cm}
